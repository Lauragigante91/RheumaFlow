...
| TC07 | 🟢 0.80 | 0.80 | 0.80 | 4 | 1 | 1 | 1.00 | SpA — raccordo con ragionamento clinico esplicitato |
...
| TC10 | 🟡 0.73 | 1.00 | 0.57 | 4 | 0 | 3 | – | SpA — sospensione implicita con verbo 'passato a' e 'sostituito' |
...
### TC10 — F1 0.73 — SpA — sospensione implicita con verbo 'passato a' e 'sostituito'
...
| Abatacept | therapy_start | 2020 | – | 0.90 | Nel 2020 switch a Abatacept sc per autonomia del paziente. |
...
| FP | `EXTRA_EVENT` | Abatacept | therapy_start | – | 2020 | – | – |

### TC07 — F1 0.80 — SpA — raccordo con ragionamento clinico esplicitato
...
| Secukinumab | therapy_start | 2019 | – | 0.90 | Nel 2019 switch a Secukinumab 150 mg mensile con risposta eccellente. |
| Secukinumab | therapy_start | 2022 | – | 0.90 | Dal 2022 in remissione clinica, ASDAS <1.3. |
...
| FP | `EXTRA_EVENT` | Secukinumab | therapy_start | – | 2022 | – | – |
...
| TC07 | FP | `EXTRA_EVENT` | Secukinumab | therapy_start | – | 2022 | – | – |
...
| TC12 | FP | `EXTRA_EVENT` | Abatacept | therapy_start | – | 2020 | – | – |
