...
|---|---|---|---|---|---|---|---|---|
| TC01 | 🟡 0.50 | 0.67 | 0.40 | 2 | 1 | 3 | – | Stop+ripresa con date esplicite |
...
| TC06 | 🟡 0.67 | 0.83 | 0.56 | 5 | 1 | 4 | 1.00 | AR — stile abbreviato da reumatologo esperto (MTX/ADA/RTX) |
...
| TC14 | 🟢 0.86 | 0.86 | 0.86 | 6 | 1 | 1 | 1.00 | SSc — terapia vascolare e immunosoppressiva complessa |
| TC15 | 🟡 0.73 | 0.80 | 0.67 | 4 | 1 | 2 | 0.00 | AR — raccordo vago con farmaci citati senza struttura di inizio/fine |
...
### TC01 — F1 0.50 — Stop+ripresa con date esplicite
...
| Acido folico | therapy_start | 2022 | – | 0.90 | Ripreso a dicembre 2022 dopo 3 mesi di wash-out con aggiunta di acido folico. |
...
| FP | `EXTRA_EVENT` | Acido folico | therapy_start | – | 2022 | – | – |

### TC06 — F1 0.67 — AR — stile abbreviato da reumatologo esperto (MTX/ADA/RTX)

**Input raccordo:**
```
AR sieropositiva FR+/CCP+ dal 2006. MTX 15 mg/sett. dal 2006, sospeso 12/2009 per ipertransaminasemia (ALT 4xULN). Leflunomide 20 mg dal 01/2010, sospesa 06/2011 per rash cutaneo diffuso. Adalimumab 40 mg ogni 2 sett. dal 07/2011, sospeso 05/2015 per perdita di risposta secondaria. RTX 1g x2 infusioni dal 06/2015, sospeso 2020 per polmonite batterica ricorrente. Dal 2021 Baricitinib 4 mg con risposta parziale.
```

**Ground truth (9 eventi):**

| Drug | Tipo | Anno | Motivo |
|---|---|---|---|
| Methotrexate | therapy_start | 2006 | – |
| Methotrexate | therapy_stop | 2009 | ipertransaminasemia |
| Leflunomide | therapy_start | 2010 | – |
| Leflunomide | therapy_stop | 2011 | rash cutaneo diffuso |
| Adalimumab | therapy_start | 2011 | – |
| Adalimumab | therapy_stop | 2015 | perdita di risposta secondaria |
| Rituximab | therapy_start | 2015 | – |
| Rituximab | therapy_stop | 2020 | polmonite batterica ricorrente |
| Baricitinib | therapy_start | 2021 | – |

**Parser output (6 eventi):**

| Drug | Tipo | Anno | Motivo | Confidence | Frammento |
|---|---|---|---|---|---|
| Methotrexate | therapy_start | 2006 | – | 0.90 | dal 2006, sospeso 12/2009 per ipertransaminasemia (ALT 4xULN). |
| Leflunomide | therapy_start | 2010 | – | 0.90 | Leflunomide 20 mg dal 01/2010, sospesa 06/2011 per rash cutaneo diffuso. |
| Leflunomide | therapy_stop | 2010 | rash cutaneo diffuso | 0.90 | Leflunomide 20 mg dal 01/2010, sospesa 06/2011 per rash cutaneo diffuso. |
| Adalimumab | therapy_start | 2011 | – | 0.90 | dal 07/2011, sospeso 05/2015 per perdita di risposta secondaria. |
| Adalimumab | therapy_start | 2015 | – | 0.90 | RTX 1g x2 infusioni dal 06/2015, sospeso 2020 per polmonite batterica ricorrente… |
| Baricitinib | therapy_start | 2021 | – | 0.90 | Dal 2021 Baricitinib 4 mg con risposta parziale. |

**Mismatch:**

| Status | Categoria | Drug | Tipo | Anno GT | Anno Parser | Motivo GT | Motivo Parser |
|---|---|---|---|---|---|---|---|
| TP_WITH_ERROR | `DATE_MISMATCH` | Leflunomide | therapy_stop | 2011 | 2010 | rash cutaneo diffuso | rash cutaneo diffuso |
| FN | `MISSING_STOP` | Methotrexate | therapy_stop | 2009 | – | ipertransaminasemia | – |
| FN | `MISSING_STOP` | Adalimumab | therapy_stop | 2015 | – | perdita di risposta secondaria | – |
| FN | `MISSING_START` | Rituximab | therapy_start | 2015 | – | – | – |
| FN | `MISSING_STOP` | Rituximab | therapy_stop | 2020 | – | polmonite batterica ricorrente | – |
| FP | `EXTRA_EVENT` | Adalimumab | therapy_start | – | 2015 | – | – |

### TC15 — F1 0.73 — AR — raccordo vago con farmaci citati senza struttura di inizio/fine
...
| Methotrexate | therapy_stop | – | mal di stomaco | 0.70 | Dall'anamnesi emerge che negli ultimi 15 anni ha assunto vari farmaci: inizialme… |
...
| FP | `EXTRA_EVENT` | Methotrexate | therapy_stop | – | – | – | mal di stomaco |
...
| TC01 | FP | `EXTRA_EVENT` | Acido folico | therapy_start | – | 2022 | – | – |
...
| TC14 | FP | `EXTRA_EVENT` | Nintedanib | therapy_start | – | 2023 | – | – |
