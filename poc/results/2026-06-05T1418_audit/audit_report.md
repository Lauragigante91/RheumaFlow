...
### TC04 — F1 0.86 — Narrativo senza date (solo sequenza temporale relativa)
...
| Drug | Tipo | Anno | Motivo | Confidence | Frammento |
|---|---|---|---|---|---|
| Etanercept | therapy_start | – | – | 0.70 | Dopo circa un anno di terapia, aggiunto Etanercept per scarso controllo della co… |
| Etanercept | therapy_stop | – | reazione cutanea al sito di iniezione | 0.70 | Dopo sei mesi di trattamento, sospeso Etanercept per reazione cutanea al sito di… |
| Ixekizumab | therapy_start | – | – | 0.70 | Avviato quindi Ixekizumab, ancora in corso. |
