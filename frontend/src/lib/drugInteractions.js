...
export const INTERACTIONS = [
  ...
  },
  {
    ...
    severity: "moderate",
    drugs: ["Allopurinolo", "Febuxostat"],
    matchOther: ["warfarin", "acenocumarolo"],
    title: "Allopurinolo / Febuxostat + VKA (Warfarin / Acenocumarolo)",
    note: "Allopurinolo inibisce parzialmente CYP2C9 → possibile aumento dell'effetto anticoagulante. Monitorare INR più frequentemente all'avvio o alla variazione di dose della terapia ipouricemizzante.",
  },
