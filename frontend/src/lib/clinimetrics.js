...
/** True se il valore è stato esplicitamente fornito (non stringa vuota, non null, non undefined) */
...
/** Valida i campi obbligatori per SpA */
export function validateSpAScores({ crp }) {
  const crpOk = isProvided(crp);
  return {
    basdai:   { valid: true,   missing: [] },
    asdas_crp:{ valid: crpOk, missing: crpOk ? [] : ["PCR"] },
    basfi:    { valid: true,   missing: [] },
  };
}
...
// Full 66/68 joint set (ACR/EULAR standard)
// TJC68 = all 68 joints | SJC66 = all except hip_l/hip_r
export const JOINTS_66_68 = [
  ...
  "hip_l", "hip_r",   // TJC68 only (tender); excluded from SJC66
  "ankle_l", "ankle_r",
  "midtarsal_l", "midtarsal_r",   // Tarsus/Midfoot — 1 per foot (subtalar merged in)
  "mtp1_l", "mtp2_l", "mtp3_l", "mtp4_l", "mtp5_l",
  "mtp1_r", "mtp2_r", "mtp3_r", "mtp4_r", "mtp5_r",
  "toe_pip1_l", "toe_pip2_l", "toe_pip3_l", "toe_pip4_l", "toe_pip5_l",
  "toe_pip1_r", "toe_pip2_r", "toe_pip3_r", "toe_pip4_r", "toe_pip5_r",
];
...
export const INDEX_LABELS = {
  ...
  petvas: "PETVAS",
  pmr_activity: "PMR/GCA attività",
  clinical_note: "Nota clinica",
  joint_exam:    "Esame articolare",
};
...
export const INDEX_DISEASES = {
  ...
  petvas: "Vasculite a grandi vasi (LVV/GCA/Takayasu)",
};
