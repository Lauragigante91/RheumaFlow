...
export const CRITERIA = [
  ...
  // ============ Artropatia da emocromatosi — EULAR 2025 ============
  {
    ...
    intro:
      "Primi criteri classificativi EULAR per l'artropatia da emocromatosi (HA). Da applicare a pazienti con dolore articolare, omozigosi HFE C282Y e sovraccarico di ferro. Score totale ≥5 = criteri soddisfatti (sensibilità 71,4%, specificità 93,3%).",
    sections: [
      {
        title: "Requisiti di entry obbligatori (TUTTI E TRE) — non scored",
        type: "check",
        groupKey: "entry",
        items: [
          { key: "joint_pain", label: "Dolore articolare", points: 0 },
          { key: "hfe_c282y_homozygous", label: "Omozigosi HFE C282Y", points: 0 },
          { key: "iron_overload", label: "Evidenza di sovraccarico di ferro (ferritina, saturazione transferrina, biopsia/RMN epatica)", points: 0 },
        ],
      },
      {
        ...
        groupKey: "clinical",
        items: [
          { key: "onset_before_50", label: "Esordio dei sintomi articolari prima dei 50 anni", points: 2 },
          { key: "iron_fist", label: "Iron fist (impossibilità a chiudere completamente il pugno per limitazione MCP 2-5)", points: 1 },
          { key: "absence_dip_swelling", label: "Assenza di tumefazione dei tessuti molli, tumefazione ossea e deformità a tutte le DIP", points: 2 },
          { key: "mcp_2_5_tenderness", label: "Dolorabilità clinica di MCP 2, 3, 4 o 5 all'esame obiettivo", points: 1 },
        ],
      },
      {
        title: "Storia di chirurgia (anca o caviglia)",
        type: "radio",
        groupKey: "hip_ankle_surgery",
        options: [
          { value: "none", label: "Nessuna chirurgia ad anca o caviglia", points: 0 },
          { value: "hip_only", label: "Solo anca", points: 1 },
          { value: "ankle_only", label: "Solo caviglia", points: 2 },
          { value: "ankle_and_hip", label: "Caviglia E anca", points: 2 },
        ],
      },
      {
        title: "Variabili radiografiche",
        type: "check",
        groupKey: "radiographic",
        items: [
          { key: "xray_mcp_jsn_surgery_cyst", label: "Rx qualsiasi MCP: riduzione spazio articolare grado 3 OPPURE chirurgia OPPURE cisti subcondrale", points: 1 },
          {
            key: "xray_ankle_jsn_or_cyst",
            label: "Rx caviglia: riduzione spazio articolare grado 3 OPPURE cisti subcondrale",
            points: 1,
            note: "Non si conta se è già stata eseguita chirurgia alla caviglia (mono- o bi-laterale)",
            disableIfRadio: { groupKey: "hip_ankle_surgery", values: ["ankle_only", "ankle_and_hip"] },
          },
        ],
      },
      {
        title: "Osteofiti uncinati radiografici (\"hook osteophytes\")",
        type: "radio",
        groupKey: "hook_osteophytes",
        note: "Non si conta se è già stata eseguita chirurgia alla caviglia (mono- o bi-laterale)",
        disableIfRadio: { groupKey: "hip_ankle_surgery", values: ["ankle_only", "ankle_and_hip"] },
        options: [
          { value: "none", label: "Assenti", points: 0 },
          { value: "mcp_only", label: "Solo MCP 2 o 3", points: 1 },
          { value: "ankle_only", label: "Solo caviglia", points: 2 },
          { value: "mcp_and_ankle", label: "MCP 2/3 E caviglia", points: 2 },
        ],
      },
    ],
    threshold: { value: 5, label: "Soddisfatti i criteri EULAR 2025 di artropatia da emocromatosi" },
    note: "I requisiti di entry (dolore articolare + omozigosi HFE C282Y + sovraccarico di ferro) sono obbligatori e NON contribuiscono allo score. Le variabili radiografiche \"caviglia\" e \"hook osteophytes\" NON vengono conteggiate se il paziente è stato sottoposto a chirurgia della caviglia (mono- o bi-laterale). Cutoff: score totale ≥5. Sensibilità 71,4%, specificità 93,3%.",
  },
