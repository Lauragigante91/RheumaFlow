...
const CASES = [
  ...
  { id: 7, focus: "MCP plurale dolenti dx", text: "MCP II e III dolenti a destra.", expected: num("mcp", [2, 3], R) },
  { id: 8, focus: "MCF abbrev", text: "Tumefazione MCF II-IV bilaterale.", expected: num("mcp", [2, 3, 4]) },
  { id: 9, focus: "IFP=PIP", text: "Dolorabilità IFP 2 e 3 mano destra.", expected: num("pip", [2, 3], R) },
  ...
  { id: 13, focus: "MTF abbrev", text: "MTF V destra tumefatta.", expected: ["mtp5_r"] },
  ...
  { id: 56, focus: "anca singolare dx (G2)", text: "Anca destra dolente.", expected: ["hip_r"] },
  { id: 57, focus: "anca singolare sn (G2)", text: "Anca sinistra tumefatta.", expected: ["hip_l"] },
  { id: 58, focus: "anche avverbio falso positivo (G3)", text: "Dolorabilità anche alla caviglia sinistra.", expected: ["ankle_l"] },
  { id: 59, focus: "anche avverbio con 'alle' (G3)", text: "Tumefazione presente anche alle ginocchia.", expected: both("knee") },
  { id: 60, focus: "gomito+anca misto lateralità sn+dx", text: "Gomito sinistro e anca destra dolenti.", expected: ["elbow_l", "hip_r"] },
  { id: 61, focus: "gomito+anca misto lateralità dx+sn", text: "Gomito destro e anca sinistra dolenti.", expected: ["elbow_r", "hip_l"] },
];
