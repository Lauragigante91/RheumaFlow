...
const CASES = [
  ...
  { id: 30, focus: "sacroiliache", text: "Dolorabilità delle sacroiliache.", expected: ["si_l", "si_r"], outOfScope: true },
  { id: 31, focus: "sacroileite bilat", text: "Sacroileite bilaterale.", expected: ["si_l", "si_r"], outOfScope: true },
  { id: 32, focus: "sacroiliaca dx", text: "Dolore sacroiliaca destra.", expected: ["si_r"], outOfScope: true },
